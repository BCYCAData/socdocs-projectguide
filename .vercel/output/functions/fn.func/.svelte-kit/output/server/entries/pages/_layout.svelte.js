import { o as onDestroy, c as create_ssr_component, b as compute_rest_props, d as spread, e as add_attribute, f as escape_attribute_value, g as escape_object, h as subscribe, v as validate_component, i as escape, j as createEventDispatcher, m as missing_component, k as compute_slots, l as each, n as set_store_value } from "../../chunks/ssr.js";
...
const Discord_fill = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M19.303 5.337A17.3 17.3 0 0 0 14.963 4c-.191.329-.403.775-.552 1.125a16.6 16.6 0 0 0-4.808 0C9.454 4.775 9.23 4.329 9.05 4a17 17 0 0 0-4.342 1.337C1.961 9.391 1.218 13.35 1.59 17.255a17.7 17.7 0 0 0 5.318 2.664a13 13 0 0 0 1.136-1.836c-.627-.234-1.22-.52-1.794-.86c.149-.106.297-.223.435-.34c3.46 1.582 7.207 1.582 10.624 0c.149.117.287.234.435.34c-.573.34-1.167.626-1.793.86a13 13 0 0 0 1.135 1.836a17.6 17.6 0 0 0 5.318-2.664c.457-4.52-.722-8.448-3.1-11.918M8.52 14.846c-1.04 0-1.889-.945-1.889-2.101s.828-2.102 1.89-2.102c1.05 0 1.91.945 1.888 2.102c0 1.156-.838 2.1-1.889 2.1m6.974 0c-1.04 0-1.89-.945-1.89-2.101s.828-2.102 1.89-2.102c1.05 0 1.91.945 1.889 2.102c0 1.156-.828 2.1-1.89 2.1"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const Twitter_fill = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M22.213 5.656a8.4 8.4 0 0 1-2.402.658A4.2 4.2 0 0 0 21.649 4c-.82.488-1.719.83-2.655 1.015a4.182 4.182 0 0 0-7.126 3.814a11.87 11.87 0 0 1-8.621-4.37a4.17 4.17 0 0 0-.566 2.103c0 1.45.739 2.731 1.86 3.481a4.2 4.2 0 0 1-1.894-.523v.051a4.185 4.185 0 0 0 3.355 4.102a4.2 4.2 0 0 1-1.89.072A4.185 4.185 0 0 0 8.02 16.65a8.4 8.4 0 0 1-6.192 1.732a11.83 11.83 0 0 0 6.41 1.88c7.694 0 11.9-6.373 11.9-11.9q0-.271-.012-.541a8.5 8.5 0 0 0 2.086-2.164"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  $$unsubscribe_activeCategory();
  return `${$$result.head += `<!-- HEAD_svelte-18oalgx_START -->${title ? `${$$result.title = `<title>${escape(title)}</title>`, ""}` : ``} ${description ? `<meta name="description"${add_attribute("content", description, 0)}>` : ``}<!-- HEAD_svelte-18oalgx_END -->`, ""} ${validate_component(KitDocs, "KitDocs").$$render($$result, { meta }, {}, {
    default: () => {
      return `${validate_component(KitDocsLayout, "KitDocsLayout").$$render($$result, { navbar, sidebar }, {}, {
        ...
        "navbar-right-alt": () => {
          return `<div class="socials" slot="navbar-right-alt">${validate_component(SocialLink, "SocialLink").$$render(
            $$result,
            {
              type: "gitHub",
